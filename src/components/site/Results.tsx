...
export function Results() {
  return (
    <section id="resultados" className="container mx-auto px-4 py-20">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {items.map((it) => (
          <div key={it.label} className="group overflow-hidden rounded-3xl border border-border bg-card shadow-soft transition-all hover:-translate-y-1 hover:shadow-elegant">
            <div className="relative aspect-[3/4] overflow-hidden">
              ...
              <div className="absolute inset-x-3 bottom-3 flex justify-between text-xs font-semibold text-wine">
                <span className="rounded-full bg-background/85 px-3 py-1">Antes</span>
                <span className="rounded-full bg-background/85 px-3 py-1">Depois</span>
              </div>
            </div>
            <div className="flex items-center gap-2 p-4">
              <it.Icon className="size-4 text-bronze" />
