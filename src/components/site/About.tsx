...
export function About() {
  ...
  return (
    <section ref={ref as any} id="sobre" className={`bg-secondary/30 py-14 sm:py-20 section-hidden ${inView ? "section-visible" : ""}`}>
      <div className="container mx-auto grid gap-6 sm:gap-8 px-6 lg:grid-cols-2 lg:items-center lg:gap-10 lg:px-4">
        <img
          src={about}
        ...
        <div className="order-2 lg:order-1 text-center lg:text-left">
          <h2 className="mb-3 sm:mb-4 text-2xl sm:text-3xl md:text-4xl font-bold text-wine">Sobre a LA MELANINA</h2>
          <p className="text-foreground/75 text-[13px] sm:text-base leading-[1.8] max-w-[95%] sm:max-w-none mx-auto lg:mx-0">
          ...
          <h3 className="mt-5 sm:mt-6 mb-4 text-lg sm:text-xl md:text-2xl font-bold text-wine">Nossos Pilares</h3>
