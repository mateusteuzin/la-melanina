  ...
  return (
    <section className="container mx-auto px-4 py-20">
      <div className="mb-12 text-center">
        ...
        <p className="mt-3 text-muted-foreground">Tudo o que você precisa para um bronze perfeito.</p>
      </div>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {items.map(({ Icon, t, d }) => (
          <div key={t} className="group rounded-3xl border border-border bg-card p-6 shadow-soft transition-all hover:-translate-y-1 hover:shadow-elegant">
            <div className="mb-4 inline-flex size-12 items-center justify-center rounded-2xl bg-gradient-bronze text-bronze-foreground transition-transform group-hover:scale-110">
